...
export const sharedCopy = {
  es: {
    ...
    oauthCallback: {
      successTitle: 'Conexión lista',
      successBody: 'Ya puedes volver a Forger.',
      errorTitle: 'No pudimos conectar la cuenta',
      errorBody: 'Vuelve a Forger e inténtalo otra vez.',
      notFoundBody: 'Esta página no pertenece a una conexión activa.',
      stateMismatch: 'La respuesta no coincide con la solicitud original.',
      providerRejected: 'El proveedor canceló o rechazó la autorización.',
      codeMissing: 'El proveedor no devolvió un código de autorización.',
    },
    officialTools: {
      gmail: {
        name: 'Gmail',
      ...
      calendar: { name: 'Google Calendar', description: 'Administra calendarios y eventos usando OAuth self-managed de Google.', secrets: {}, actions: {}, changelog: ['Conector OAuth self-managed de Google Calendar.'] },
      sheets: { name: 'Google Sheets', description: 'Lee y actualiza rangos de hojas usando OAuth self-managed de Google.', secrets: {}, actions: {}, changelog: ['Conector OAuth self-managed de Google Sheets.'] },
      drive: { name: 'Google Drive', description: 'Busca, descarga y sube archivos usando OAuth self-managed de Google.', secrets: {}, actions: {}, changelog: ['Conector OAuth self-managed de Google Drive.'] },
      docs: { name: 'Google Docs', description: 'Lee, crea y edita documentos usando OAuth self-managed de Google.', secrets: {}, actions: {}, changelog: ['Conector OAuth self-managed de Google Docs.'] },
      github: { name: 'GitHub', description: 'Lee repositorios y administra issues con OAuth self-managed por device flow.', secrets: {}, actions: {}, changelog: ['Conector OAuth self-managed de GitHub.'] },
      notion: { name: 'Notion', description: 'Busca, lee y actualiza paginas y bases con token de integracion local.', secrets: {}, actions: {}, changelog: ['Conector local de Notion con token de integracion.'] },
      slack: { name: 'Slack', description: 'Lee canales y envia mensajes con un token de bot guardado localmente.', secrets: {}, actions: {}, changelog: ['Conector local de Slack con token de bot.'] },
      trello: { name: 'Trello', description: 'Lista tableros, columnas y tarjetas, y crea tarjetas con API key y token locales.', secrets: {}, actions: {}, changelog: ['Conector local de Trello con API key y token.'] },
      figma: { name: 'Figma', description: 'Lee archivos, nodos, imagenes, comentarios y proyectos con token local.', secrets: {}, actions: {}, changelog: ['Conector local de Figma.'] },
      zendesk: { name: 'Zendesk', description: 'Busca usuarios y administra tickets con subdominio, email y API token locales.', secrets: {}, actions: {}, changelog: ['Conector local de Zendesk.'] },
      discord: { name: 'Discord', description: 'Opera servidores, canales, threads y mensajes con bot token local.', secrets: {}, actions: {}, changelog: ['Conector local de Discord.'] },
      calendly: { name: 'Calendly', description: 'Lee tipos de evento, disponibilidad, eventos e invitados con PAT local.', secrets: {}, actions: {}, changelog: ['Conector local de Calendly.'] },
      gitlab: { name: 'GitLab', description: 'Lee proyectos, issues, merge requests y pipelines con access token local.', secrets: {}, actions: {}, changelog: ['Conector local de GitLab.'] },
      shopify: { name: 'Shopify', description: 'Administra productos, pedidos, clientes e inventario con Admin API token local.', secrets: {}, actions: {}, changelog: ['Conector local de Shopify.'] },
      whatsapp_business: { name: 'WhatsApp Business Cloud', description: 'Envia mensajes oficiales con token de Meta y cuenta WABA locales.', secrets: {}, actions: {}, changelog: ['Conector local de WhatsApp Business Cloud.'] },
      telegram: { name: 'Telegram', description: 'Opera un bot de Telegram con token local.', secrets: {}, actions: {}, changelog: ['Conector local de Telegram.'] },
      sendgrid: { name: 'SendGrid', description: 'Envia emails y administra templates/contactos con API key local.', secrets: {}, actions: {}, changelog: ['Conector local de SendGrid.'] },
      postmark: { name: 'Postmark', description: 'Envia emails y administra templates/bounces con Server API token local.', secrets: {}, actions: {}, changelog: ['Conector local de Postmark.'] },
      twilio: { name: 'Twilio', description: 'Envia SMS, WhatsApp y llamadas con API key local.', secrets: {}, actions: {}, changelog: ['Conector local de Twilio.'] },
      meta_ads: { name: 'Meta Ads', description: 'Lee y prepara campanas pausadas con OAuth self-managed local.', secrets: {}, actions: {}, changelog: ['Conector OAuth self-managed de Meta Ads.'] },
  ...
  en: {
    ...
    oauthCallback: {
      successTitle: 'Connection ready',
      successBody: 'You can return to Forger.',
      errorTitle: 'Could not connect the account',
      errorBody: 'Return to Forger and try again.',
      notFoundBody: 'This page is not part of an active connection.',
      stateMismatch: 'The response does not match the original request.',
      providerRejected: 'The provider canceled or rejected the authorization.',
      codeMissing: 'The provider did not return an authorization code.',
    },
    officialTools: {
      gmail: {
        name: 'Gmail',
      ...
      calendar: { name: 'Google Calendar', description: 'Manages calendars and events with self-managed Google OAuth.', secrets: {}, actions: {}, changelog: ['Self-managed Google Calendar OAuth connector.'] },
      sheets: { name: 'Google Sheets', description: 'Reads and updates spreadsheet ranges with self-managed Google OAuth.', secrets: {}, actions: {}, changelog: ['Self-managed Google Sheets OAuth connector.'] },
      drive: { name: 'Google Drive', description: 'Searches, downloads, and uploads files with self-managed Google OAuth.', secrets: {}, actions: {}, changelog: ['Self-managed Google Drive OAuth connector.'] },
      docs: { name: 'Google Docs', description: 'Reads, creates, and edits documents with self-managed Google OAuth.', secrets: {}, actions: {}, changelog: ['Self-managed Google Docs OAuth connector.'] },
      github: { name: 'GitHub', description: 'Reads repositories and manages issues with self-managed device-flow OAuth.', secrets: {}, actions: {}, changelog: ['Self-managed GitHub OAuth connector.'] },
      notion: { name: 'Notion', description: 'Searches, reads, and updates pages and databases with a local integration token.', secrets: {}, actions: {}, changelog: ['Local Notion integration-token connector.'] },
      slack: { name: 'Slack', description: 'Reads channels and sends messages with a locally stored bot token.', secrets: {}, actions: {}, changelog: ['Local Slack bot-token connector.'] },
      trello: { name: 'Trello', description: 'Lists boards, lists, cards, and creates cards with local API key and token.', secrets: {}, actions: {}, changelog: ['Local Trello API key and token connector.'] },
      figma: { name: 'Figma', description: 'Reads files, nodes, images, comments, and projects with a local token.', secrets: {}, actions: {}, changelog: ['Local Figma connector.'] },
      zendesk: { name: 'Zendesk', description: 'Searches users and manages tickets with local subdomain, email, and API token.', secrets: {}, actions: {}, changelog: ['Local Zendesk connector.'] },
      discord: { name: 'Discord', description: 'Operates guilds, channels, threads, and messages with a local bot token.', secrets: {}, actions: {}, changelog: ['Local Discord connector.'] },
      calendly: { name: 'Calendly', description: 'Reads event types, availability, scheduled events, and invitees with a local PAT.', secrets: {}, actions: {}, changelog: ['Local Calendly connector.'] },
      gitlab: { name: 'GitLab', description: 'Reads projects, issues, merge requests, and pipelines with a local access token.', secrets: {}, actions: {}, changelog: ['Local GitLab connector.'] },
      shopify: { name: 'Shopify', description: 'Manages products, orders, customers, and inventory with a local Admin API token.', secrets: {}, actions: {}, changelog: ['Local Shopify connector.'] },
      whatsapp_business: { name: 'WhatsApp Business Cloud', description: 'Sends official messages with a local Meta token and WABA account.', secrets: {}, actions: {}, changelog: ['Local WhatsApp Business Cloud connector.'] },
      telegram: { name: 'Telegram', description: 'Operates a Telegram bot with a local token.', secrets: {}, actions: {}, changelog: ['Local Telegram connector.'] },
      sendgrid: { name: 'SendGrid', description: 'Sends email and manages templates/contacts with a local API key.', secrets: {}, actions: {}, changelog: ['Local SendGrid connector.'] },
      postmark: { name: 'Postmark', description: 'Sends email and manages templates/bounces with a local Server API token.', secrets: {}, actions: {}, changelog: ['Local Postmark connector.'] },
      twilio: { name: 'Twilio', description: 'Sends SMS, WhatsApp messages, and calls with a local API key.', secrets: {}, actions: {}, changelog: ['Local Twilio connector.'] },
      meta_ads: { name: 'Meta Ads', description: 'Reads and prepares paused campaigns with local self-managed OAuth.', secrets: {}, actions: {}, changelog: ['Self-managed Meta Ads OAuth connector.'] },
      forger_chrome_extension: {
        name: 'Forger Chrome Extension',

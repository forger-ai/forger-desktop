...
export type SocialTab = 'friends' | 'requests' | 'apps' | 'forum' | 'add' | 'profile' | 'search';
...
export const readLastSessionTab = (): SocialTab | null => {
  ...
  return value === 'requests' || value === 'apps' || value === 'forum' || value === 'add' || value === 'profile' || value === 'search' ? value : 'friends';
};

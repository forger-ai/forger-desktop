...
const hasAppliedSchedule = (workflow: Workflow): boolean =>
  ...
  (workflow.appliedRevision === workflow.revision &&
                    ...
                    <Stack spacing={1}>
                      ...
                      >
                        ...
                        <Chip
                          size="small"
                          variant="outlined"
                          label={formatSchedule(workflow, t)}
                        />
                      </Stack>
                ...
                >
                  ...
                  >
                    <span>
                      <IconButton
                        ...
                        size="small"
                        disabled={
                          busy || workflow.running || !workflow.appliedRevision
                        }
                  ...
                  {hasAppliedSchedule(workflow) ? (
                    <Tooltip
                      title={
                        workflow.enabled
                          ? copy.deactivateSchedule
                          : copy.activateSchedule
                      }
                    >
                      <span>
                        <IconButton
                          aria-label={workflow.enabled ? copy.disable : copy.enable}
                          size="small"
                          disabled={busy || !workflow.appliedRevision}

...
export const es = {
  ...
  cloud: {
    ...
    title: 'Registrate con tu correo o inicia sesion',
    body: 'Usa tu cuenta para dejar reviews y enviar feedback sobre las apps.',
    ...
    signedInAs: (email: string) => `Sesion iniciada como ${email}`,

...
export const en = {
  ...
  settings: {
    ...
    conversationReportBody: 'Review the sanitized conversation and technical trace before sending it to Forger Cloud. Local paths and secrets are redacted or replaced with Forger aliases.',

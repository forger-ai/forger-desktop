...
const initialSettings: Settings = { userEmail: '', plan: 'Free', safeMode: false, codexDefaults: { model: 'gpt-5.4', reasoningEffort: 'medium', }, defaultAgentProvider: 'auto', defaultChatPermissionMode: 'safe', agentDefaults: { codex: { model: 'gpt-5.4', reasoningEffort: 'medium', }, claude: { model: 'claude-sonnet-4-6', effort: 'high', }, }, providerConnections: {}, };

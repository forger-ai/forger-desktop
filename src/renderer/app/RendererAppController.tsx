...
await navigator.clipboard.writeText(JSON.stringify({ ...conversationDiagnosticDialog.report, description: conversationDiagnosticDialog.description.trim() || undefined }, null, 2)); setConversationDiagnosticDialog((current) => ({ ...current, userMessage: t.settings.conversationReportCopied })); };

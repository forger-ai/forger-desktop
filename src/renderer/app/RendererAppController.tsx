...
open: boolean; appId: string; appName: string; input: PrepareSocialAppReviewInput; busy?: boolean; }
...
setBannerSeverity(result.success ? 'info' : 'error'); setBannerMessage(result.userMessage); if (result.status) { setAntigravityAuthStatus(result.status); }

...
const IPC_CHANNELS = {
  ...
  initializeCampaignMeasurement: 'forger:campaign-measurement:initialize',
  getCampaignMeasurementStatus: 'forger:campaign-measurement:status',
  setCampaignMeasurementConsent: 'forger:campaign-measurement:consent',
  recordCampaignFirstAppCreated: 'forger:campaign-measurement:first-app-created',
...
const api: ForgerDesktopApi = {
  ...
  initializeCampaignMeasurement: (existingProfile) => ipcRenderer.invoke(IPC_CHANNELS.initializeCampaignMeasurement, existingProfile),
  getCampaignMeasurementStatus: () => ipcRenderer.invoke(IPC_CHANNELS.getCampaignMeasurementStatus),
  setCampaignMeasurementConsent: (input) => ipcRenderer.invoke(IPC_CHANNELS.setCampaignMeasurementConsent, input),
  recordCampaignFirstAppCreated: () => ipcRenderer.invoke(IPC_CHANNELS.recordCampaignFirstAppCreated),
  ...
  filesDiscardStagedForChat: (input) => ipcRenderer.invoke(IPC_CHANNELS.filesDiscardStagedForChat, {
    grantIds: input.grantIds,
  }),
  filesReleaseSelections: (input) => ipcRenderer.invoke(IPC_CHANNELS.filesReleaseSelections, {
    grantIds: input.grantIds,
  }),
  ...
  filesImport: (input) => ipcRenderer.invoke(IPC_CHANNELS.filesImport, {
    grantIds: input.grantIds,

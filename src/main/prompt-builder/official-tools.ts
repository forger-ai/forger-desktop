  ...
  if (typeof input.gmailReady === 'boolean') {
    definitions.push({
      ...
      actions: [
        ...
        { id: 'gmail.get_profile', name: 'Get profile', description: 'Read the connected Gmail profile and history cursor.', risk: 'low' },
        { id: 'gmail.list_labels', name: 'List labels', description: 'List Gmail labels and basic counts.', risk: 'low' },
        { id: 'gmail.search_messages', name: 'Search messages', description: 'Search Gmail messages.', risk: 'medium' },
        { id: 'gmail.list_threads', name: 'List threads', description: 'List Gmail threads with summary metadata and pagination.', risk: 'medium' },
        { id: 'gmail.read_thread', name: 'Read thread', description: 'Read a Gmail thread.', risk: 'high' },
        { id: 'gmail.list_changes', name: 'List changes', description: 'List Gmail history changes for incremental sync.', risk: 'medium' },
        { id: 'gmail.modify_thread', name: 'Modify thread', description: 'Apply label changes to a Gmail thread.', risk: 'medium' },
        { id: 'gmail.move_thread', name: 'Move thread', description: 'Trash or untrash a Gmail thread.', risk: 'high' },
        { id: 'gmail.read_attachment', name: 'Read attachment', description: 'Read a Gmail attachment.', risk: 'high' },
        { id: 'gmail.list_drafts', name: 'List drafts', description: 'List Gmail drafts.', risk: 'high' },
        { id: 'gmail.get_draft', name: 'Get draft', description: 'Read a Gmail draft.', risk: 'high' },
        { id: 'gmail.save_draft', name: 'Save draft', description: 'Create or update a Gmail draft.', risk: 'high' },
        { id: 'gmail.delete_draft', name: 'Delete draft', description: 'Delete a Gmail draft.', risk: 'high' },
        { id: 'gmail.send_draft', name: 'Send draft', description: 'Send an existing Gmail draft.', risk: 'high' },

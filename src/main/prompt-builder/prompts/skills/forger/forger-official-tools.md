...
description: Use when operating Forger-owned MCP tools for apps, prompts, installed app lifecycle, Gmail, WhatsApp, or official platform actions without Codex-local connector fallbacks.
---

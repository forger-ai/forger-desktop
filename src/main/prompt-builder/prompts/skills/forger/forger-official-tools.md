...
description: Use when operating Forger-owned MCP tools for apps, prompts, installed app lifecycle, Gmail, or official platform actions without Codex-local connector fallbacks.
---

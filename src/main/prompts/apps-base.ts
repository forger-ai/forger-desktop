...
export const buildForgerAppAgentsMarkdown = (appId: string, manifest: PromptAppManifest | null): string => {
  ...
  return [
    ...
    '- Forger MCP can expose memory tools. In app conversations you may read global memory and this app memory, and you may create, update, or delete only this app memory.',
    '- You may save useful app memory proactively, but only for stable preferences, workflow constraints, or facts that help future work in this app.',
    '- Never save secrets, credentials, sensitive personal data, or delicate personal inferences in memory.',
    '- When you save app memory, explicitly tell the user what you saved in plain language. Use wording like: "He tomado nota de esto para esta app. Puedes administrarlo en Configuraciones > Memoria."',

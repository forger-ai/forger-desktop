...
export const AGENT_TOOL_PACKAGES: AgentToolPackageDefinition[] = [
  ...
  },
  {
    id: 'official:slack',
    name: 'Slack',
    description: 'Herramienta oficial para leer y enviar mensajes de Slack con un token local guardado en secretos.',
    icon: 'forger',
    tools: [
      {
        id: 'slack.connection.status',
        packageId: 'official:slack',
        name: 'Estado de Slack',
        description: 'Revisa si el token de Slack esta conectado y a que espacio pertenece.',
        category: 'consulta',
        risk: 'bajo',
        defaultRequiresApproval: false,
      },
      ...
      },
      {
        ...
        packageId: 'official:slack',
        name: 'Leer mensajes',
        description: 'Lee los mensajes recientes de un canal de Slack.',
        category: 'consulta',
        risk: 'alto',
        defaultRequiresApproval: true,
      },
  ...
  },
  {
    id: 'official:trello',
    name: 'Trello',
    description: 'Herramienta oficial para revisar tableros y crear tarjetas de Trello con credenciales locales guardadas en secretos.',
    icon: 'forger',
    tools: [
      {
        id: 'trello.connection.status',
        packageId: 'official:trello',
        name: 'Estado de Trello',
      ...
      },
      {
        ...
        description: 'Lista los tableros de Trello de la cuenta conectada.',
        category: 'consulta',
        risk: 'bajo',
        defaultRequiresApproval: false,
      },
      {
        ...
        description: 'Lista las columnas de un tablero de Trello.',
        category: 'consulta',
        risk: 'bajo',
        defaultRequiresApproval: false,
      },
      {
        ...
        description: 'Lista las tarjetas de una columna de Trello.',
        category: 'consulta',
        risk: 'medio',
        defaultRequiresApproval: true,
      },
      {
        ...
        packageId: 'official:trello',
        name: 'Crear tarjeta',
        description: 'Crea una tarjeta nueva en una columna de Trello.',
        category: 'app',
        risk: 'alto',
        defaultRequiresApproval: true,
      },

...
export const AGENT_TOOL_PACKAGES: AgentToolPackageDefinition[] = [
  {
    ...
    tools: [
      ...
      },
      {
        ...
        packageId: FORGER_TOOL_PACKAGE_ID,
        name: 'Guardar borrador de flujo',
        description: 'Crea o actualiza el borrador de un flujo sin aplicarlo, activarlo ni ejecutarlo.',
        category: 'app',
        risk: 'medio',
        defaultRequiresApproval: true,
      },
      {
        id: 'forger_workflow_review',
        packageId: FORGER_TOOL_PACKAGE_ID,
        name: 'Revisar borrador de flujo',
        description: 'Valida un borrador y explica sus problemas sin ejecutar pasos ni cambiar datos.',
        category: 'consulta',
        risk: 'bajo',
        defaultRequiresApproval: false,
      },
      {
        id: 'forger_workflow_apply',
        packageId: FORGER_TOOL_PACKAGE_ID,
        name: 'Aplicar revision de flujo',
        description: 'Crea una revision inmutable desde un borrador revisado sin ejecutar ni activar el horario.',
        category: 'app',
        risk: 'medio',
        defaultRequiresApproval: true,
      },

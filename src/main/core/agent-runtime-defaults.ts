...
export const APP_CLAUDE_MODEL_OPTIONS = [
  { displayModelName: 'Sonnet 5', realModelName: 'claude-sonnet-5', defaultEffort: 'high' as const },
  { displayModelName: 'Fable 5', realModelName: 'claude-fable-5', defaultEffort: 'max' as const },

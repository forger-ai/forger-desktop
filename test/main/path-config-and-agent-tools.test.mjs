...
test('agent tool package definitions are unique and initialize approval defaults', () => {
  ...
  assert.equal(Object.hasOwn(settings.approvals, 'whatsapp.connection.status'), false);
  assert.equal(Object.hasOwn(settings.approvals, 'whatsapp.list_chats'), false);
  assert.equal(Object.hasOwn(settings.approvals, 'whatsapp.read_messages'), false);
  assert.equal(Object.hasOwn(settings.approvals, 'whatsapp.download_attachment'), false);
  assert.equal(Object.hasOwn(settings.approvals, 'whatsapp.send_message'), false);

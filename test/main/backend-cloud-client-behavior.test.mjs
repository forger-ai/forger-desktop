...
test('cloud normalizers reject malformed top-level and nested cloud records', () => {
  ...
  assert.deepEqual(normalizeCloudDevice({
    ...
    installed_apps: [
      null,
      { id: '', name: 'Missing id' },
      { id: 'finance-os', name: 77, status: 10, version: 4, execution_phase: 'bad', execution_mode: 'bad', connect_mode: 'bad' },
      { id: 'recipes', name: 'Recipes', status: 'running', version: '2.0.0', local_network_share_supported: true, remote_tunnel_supported: true, execution_phase: 'running', execution_mode: 'remote_tunnel', connect_mode: 'remote_tunnel' },
    ],
  }), {
    id: 8,
    deviceUid: '',

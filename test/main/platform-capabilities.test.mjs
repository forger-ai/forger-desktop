...
const { appAllowsAudioInput, appAllowsSpeechToText, appAllowsTextToSpeech, normalizePlatformCapabilities } = require('../../dist-electron/shared/platform-capabilities.js');

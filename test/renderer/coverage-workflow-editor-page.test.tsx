...
describe('WorkflowEditorPage', () => {
  it('wires workflow data and primary navigation without a banner', async () => {
    ...
    await user.click(screen.getByRole('button', { name: t.sections.workflows.saveDraft }));
  ...
  it('shows a dismissible banner and locks save while busy', async () => {
    ...
    expect(screen.getByRole('button', { name: t.sections.workflows.saveDraft })).toBeDisabled();

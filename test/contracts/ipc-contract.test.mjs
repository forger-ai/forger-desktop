  ...
  assert.deepEqual(
    {
      ...
      getCloudDevices: IPC_CHANNELS.getCloudDevices,
      updateCloudDeviceName: IPC_CHANNELS.updateCloudDeviceName,
  ...
  assert.deepEqual(
    {
      ...
      sidekicksSendScreen: IPC_CHANNELS.sidekicksSendScreen,
      sidekicksSetPersonalAgent: IPC_CHANNELS.sidekicksSetPersonalAgent,
      sidekicksSetVoiceConfig: IPC_CHANNELS.sidekicksSetVoiceConfig,
      sidekicksSpeak: IPC_CHANNELS.sidekicksSpeak,
